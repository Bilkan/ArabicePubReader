...
//		text.setTypeface(Properties.UIFont);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		menu.add(0, 0, 0, ArabicUtilities.reshape(getString(R.string.menu_toc))).setIcon(R.drawable.list);
		menu.add(0, 1, 0, ArabicUtilities.reshape(getString(R.string.MenuSettings))).setIcon(R.drawable.setting);
		menu.add(0, 2, 0, ArabicUtilities.reshape(getString(R.string.MenuOpen))).setIcon(R.drawable.file_open);
		menu.add(0, 3, 0, ArabicUtilities.reshape(getString(R.string.MenuAbout))).setIcon(R.drawable.about);
//		menu.add(0,4,0,"Trih");
		return true;
	}
