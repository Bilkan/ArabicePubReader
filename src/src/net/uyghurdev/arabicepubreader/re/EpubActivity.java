...
public class EpubActivity extends TabActivity {
	   public void onCreate(Bundle savedInstanceState) {
	        ...
	        * By using TabSpec setIndicator() we can set name to tab. */
	        ...
	        open.setIndicator(ArabicUtilities.reshape(getString(R.string.tab_storage)), getResources().getDrawable(R.drawable.folder)).setContent(new Intent(this,BookShelf.class));
